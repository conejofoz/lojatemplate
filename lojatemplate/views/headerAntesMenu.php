        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="<?php echo BASE_URL; ?>/index.php">
                        <!-- Logo icon image, you can use font-icon also --><b>
                            <!--This is dark logo icon--><img src="<?php echo BASE_URL; ?>/plugins/images/logo2.jpg" alt="home" class="dark-logo hidden-xs" /><!--This is light logo icon--><img src="<?php echo BASE_URL; ?>/plugins/images/logo2.jpg" alt="home" class="light-logo hidden-xs" />
                            <!--This is dark logo icon--><img src="<?php echo BASE_URL; ?>/plugins/images/logo2.jpg" alt="home" class="dark-logo hidden-sm hidden-md hidden-lg" width="33px" height="31px" /> <!-- quando muda de tema funciona a segunda parte--><img src="<?php echo BASE_URL; ?>/plugins/images/logo2.jpg" alt="home" class="light-logo hidden-sm hidden-md hidden-lg hidden-xs" width="33px" height="31px" /><!--coloquei o hiden-xs pra sumir mesmo pq coloquei o grande depois do menu mobile-->
                     </b>
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <img src="<?php echo BASE_URL; ?>/plugins/images/logo2.jpg" alt="home" class="light-logo hidden-sm hidden-md hidden-lg" width="120px" height="70px" />
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)"> <img src="<?php echo BASE_URL; ?>/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b><span class="caret"></span> </a>
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="<?php echo BASE_URL; ?>/plugins/images/users/varun.jpg" alt="user" /></div>
                                    <div class="u-text">
                                        <h4>Steave Jobs</h4>
